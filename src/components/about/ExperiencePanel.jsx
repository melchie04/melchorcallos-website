  ...
  const ExperienceCard = ({ company }) => (
    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md px-6 py-3 flex md:flex-col">
      <div>
        ...
        <h4 className="md:text-sm text-xs text-dark/80 dark:text-light/80 select-none mb-2">{company.name}</h4>
        <p className="md:text-sm text-xs text-dark/50 dark:text-light/50 select-none mb-2">{company.duration}</p>
      </div>
    </div>
  );
